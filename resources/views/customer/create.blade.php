          ...
          <form class="form" method="POST" action="{{ route('customers.store') }}">
            ...
            <div class="card py-5">
              ...
              <div class="bmd-form-group{{ $errors->has('phone') ? ' has-danger' : '' }} mt-3">
                <div class="input-group col-md-8 offset-md-1">
                  <input type="text" name="phone" class="form-control" id="phone" placeholder="@lang('app.phone')" value="{{ old('phone') }}" required>
                </div>
                @if ($errors->has('phone'))
              ...
              <div class="bmd-form-group{{ $errors->has('contact_pref') ? ' has-danger' : '' }} mt-3">
                <div class="col-md-8 offset-md-1">
                  ...
                  <select class="selectpicker form-control" id="contact_pref" name="contact_pref" data-style="btn btn-warning text-white" required>
              ...
              <div class="bmd-form-group{{ $errors->has('newsletter') ? ' has-danger' : '' }} mt-3">
                <div class="col-md-8 offset-md-1">
                  ...
                  <select class="selectpicker form-control" id="newsletter" name="newsletter" data-style="btn btn-warning text-white" required>
                    <option value="">{{ __('- Select one -') }}</option>
