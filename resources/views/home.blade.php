      ...
      <div class="row">
        <div class="col-md-8 text-primary">
          ...
          <ul class="pl-2 list-unstyled">
            <li class="my-2"><a href="{{ route('aboutus') }}">Prospect Identification</a></li>
            <li class="my-2"><a href="{{ route('aboutus') }}">Preliminary Prospect Evaluation</a></li>
            <li class="my-2"><a href="{{ route('aboutus') }}">The Most Comprehensive Recruiting Database</a></li>
            <li class="my-2"><a href="{{ route('aboutus') }}">Information on a Timely Basis</a></li>
            <li class="my-2"><a href="{{ route('aboutus') }}">Reports</a></li>
            <li class="my-2"><a href="{{ route('aboutus') }}">Community</a></li>
            <li class="my-2"><a href="{{ route('aboutus') }}">Exclusivity</a></li>
          </ul> <br/>
