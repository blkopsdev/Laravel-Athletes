@extends('layouts.auth.app', ['activePage' => 'athletes.create', 'titlePage' => "Add a New Athlete"])
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12">
          <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">{{ __('New Athlete') }}</li>
            </ol>
          </nav>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12">
          <form class="form" method="POST" action="{{ route('athletes.store') }}">
            @csrf
            <div class="card ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('position') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('position') ? ' is-invalid' : '' }}" name="position" id="input-position" type="text" value="{{ old('position') }}" required />
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('weight') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('weight') ? ' is-invalid' : '' }}" name="weight" id="input-weight" type="text" value="{{ old('weight') }}"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('forty') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('forty') ? ' is-invalid' : '' }}" name="forty" id="input-forty" type="text" value="{{ old('forty') }}" />
                      @if ($errors->has('forty'))
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('city_school') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('city_school') ? ' is-invalid' : '' }}" name="city_school" id="input-city-school" type="text" value="{{ old('city_school') }}" />
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('state') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('state') ? ' is-invalid' : '' }}" name="state" id="input-state" type="text" value="{{ old('state') }}" />
                      @if ($errors->has('state'))
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('college_commitment') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('college_commitment') ? ' is-invalid' : '' }}" name="college_commitment" id="input-college-commitment" type="text" value="{{ old('college_commitment') }}" />
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group p-0 border-bottom{{ $errors->has('synopsis') ? ' has-danger' : '' }}">
                      <textarea class="form-control{{ $errors->has('synopsis') ? ' is-invalid' : '' }}" name="synopsis" id="input-synopsis" rows="5">{{ old('synopsis') }}</textarea>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group p-0 border-bottom{{ $errors->has('national_honors') ? ' has-danger' : '' }}">
                      <textarea class="form-control{{ $errors->has('national_honors') ? ' is-invalid' : '' }}" name="national_honors" id="input-national-honors" rows="5">{{ old('national_honors') }}</textarea>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group p-0 border-bottom{{ $errors->has('other_rankings') ? ' has-danger' : '' }}">
                      <textarea class="form-control{{ $errors->has('other_rankings') ? ' is-invalid' : '' }}" name="other_rankings" id="input-other-rankings" rows="5">{{ old('other_rankings') }}</textarea>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group p-0 border-bottom{{ $errors->has('junior_local_honors') ? ' has-danger' : '' }}">
                      <textarea class="form-control{{ $errors->has('junior_local_honors') ? ' is-invalid' : '' }}" name="junior_local_honors" id="input-junior-local-honors" rows="5">{{ old('junior_local_honors') }}</textarea>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group p-0 border-bottom{{ $errors->has('sophomore_local_honors') ? ' has-danger' : '' }}">
                      <textarea class="form-control{{ $errors->has('sophomore_local_honors') ? ' is-invalid' : '' }}" name="sophomore_local_honors" id="input-sophomore-local-honors" rows="5">{{ old('sophomore_local_honors') }}</textarea>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group p-0 border-bottom{{ $errors->has('freshman_local_ranking') ? ' has-danger' : '' }}">
                      <textarea class="form-control{{ $errors->has('freshman_local_ranking') ? ' is-invalid' : '' }}" name="freshman_local_ranking" id="input-freshman-local-ranking" rows="5">{{ old('freshman_local_ranking') }}</textarea>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group p-0 border-bottom{{ $errors->has('combines') ? ' has-danger' : '' }}">
                      <textarea class="form-control{{ $errors->has('combines') ? ' is-invalid' : '' }}" name="combines" id="input-combines" rows="5">{{ old('combines') }}</textarea>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group p-0 border-bottom{{ $errors->has('other_comments') ? ' has-danger' : '' }}">
                      <textarea class="form-control{{ $errors->has('other_comments') ? ' is-invalid' : '' }}" name="other_comments" id="input-other-comments" rows="5">{{ old('other_comments') }}</textarea>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group p-0 border-bottom{{ $errors->has('news_and_notes') ? ' has-danger' : '' }}">
                      <textarea class="form-control{{ $errors->has('news_and_notes') ? ' is-invalid' : '' }}" name="news_and_notes" id="input-news-and-notes" rows="5">{{ old('news_and_notes') }}</textarea>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group p-0 border-bottom{{ $errors->has('top_offers') ? ' has-danger' : '' }}">
                      <textarea class="form-control{{ $errors->has('top_offers') ? ' is-invalid' : '' }}" name="top_offers" id="input-top-offers" rows="5">{{ old('top_offers') }}</textarea>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('projected_college_position') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('projected_college_position') ? ' is-invalid' : '' }}" name="projected_college_position" id="input-projected-college-position" type="text" value="{{ old('projected_college_position') }}" />
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('national_ranking_position') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('national_ranking_position') ? ' is-invalid' : '' }}" name="national_ranking_position" id="input-national-ranking-position" type="text" value="{{ old('national_ranking_position') }}" />
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('state_ranking') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('state_ranking') ? ' is-invalid' : '' }}" name="state_ranking" id="input-state-ranking" type="text" value="{{ old('state_ranking') }}" />
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('rating') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('rating') ? ' is-invalid' : '' }}" name="rating" id="input-rating" type="text" value="{{ old('rating') }}" />
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('class') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('class') ? ' is-invalid' : '' }}" name="class" id="input-class" type="text" value="{{ old('class') }}" />
                      @if ($errors->has('class'))
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group p-0 border-bottom{{ $errors->has('links') ? ' has-danger' : '' }}">
                      <textarea class="form-control{{ $errors->has('links') ? ' is-invalid' : '' }}" name="links" id="input-links" rows="5">{{ old('links') }}</textarea>
                      @if ($errors->has('links'))
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group p-0 border-bottom{{ $errors->has('contact_information') ? ' has-danger' : '' }}">
                      <textarea class="form-control{{ $errors->has('contact_information') ? ' is-invalid' : '' }}" name="contact_information" id="input-contact-information" rows="5">{{ old('contact_information') }}</textarea>
